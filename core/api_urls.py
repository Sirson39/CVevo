...
urlpatterns = [
    ...
    path('admin/login/', api_views.AdminLoginView.as_view(), name='api_admin_login'),
    path('admin/dashboard/', api_views.AdminDashboardView.as_view(), name='api_admin_dashboard'),
    path('admin/users/', api_views.AdminUsersView.as_view(), name='api_admin_users'),
    path('admin/users/<int:pk>/', api_views.AdminUsersView.as_view(), name='api_admin_users_detail'),
    path('admin/jobs/', api_views.AdminJobsView.as_view(), name='api_admin_jobs'),
    path('admin/jobs/<int:pk>/', api_views.AdminJobsView.as_view(), name='api_admin_jobs_detail'),
    path('admin/resumes/', api_views.AdminResumesView.as_view(), name='api_admin_resumes'),
    path('admin/resumes/<int:pk>/', api_views.AdminResumesView.as_view(), name='api_admin_resumes_detail'),
    path('admin/ats/', api_views.AdminATSView.as_view(), name='api_admin_ats'),
    path('admin/ats/<int:pk>/', api_views.AdminATSView.as_view(), name='api_admin_ats_detail'),
    path('admin/support/', api_views.AdminSupportView.as_view(), name='api_admin_support'),
    path('admin/support/<int:pk>/', api_views.AdminSupportView.as_view(), name='api_admin_support_detail'),
    path('admin/support/<int:pk>/resolve/', api_views.AdminSupportView.as_view(), name='api_admin_support_resolve'),
